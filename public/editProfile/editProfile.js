...
// console.log(surName) ;
const Email = document.querySelector("#email-MobNum") ;
// console.log(Email) ;
...
async function getUserData(uid) {
    try {
        ...
        if (docSnap.exists()) {
            ...
            const {lastName: lastNameFromDB, firstName: firstNameFromDB , email ,mobileNumber:MobNumfromDB,Password : passwordFromDB} = docSnap.data()
            // userName.value = userNameFromDB
            firstName.value = firstNameFromDB
            surName.value = lastNameFromDB
            userMobNum.value = MobNumfromDB
            Email.value = email
...
function editProfileHandler() {
    console.log(surName.value, firstName.value,  userMobNum.value, profilePicture.files[0], "edit button working properly")
